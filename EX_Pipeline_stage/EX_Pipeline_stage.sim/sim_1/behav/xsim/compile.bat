...
REM
REM Generated by Vivado on Mon Aug 24 11:23:56 +0530 2026
...
echo "xvlog --incr --relax -prj tb_execute_vlog.prj"
call xvlog  --incr --relax -prj tb_execute_vlog.prj -log xvlog.log
