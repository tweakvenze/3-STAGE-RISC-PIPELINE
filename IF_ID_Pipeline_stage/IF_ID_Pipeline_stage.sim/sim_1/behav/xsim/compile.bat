...
REM
REM Generated by Vivado on Thu Feb 05 00:53:07 +0530 2026
...
echo "xvlog --incr --relax -prj tb_if_id_vlog.prj"
call xvlog  --incr --relax -prj tb_if_id_vlog.prj -log xvlog.log
