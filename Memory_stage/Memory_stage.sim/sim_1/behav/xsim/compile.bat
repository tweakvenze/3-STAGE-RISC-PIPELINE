...
REM
REM Generated by Vivado on Mon Feb 16 10:33:01 +0530 2026
...
echo "xvlog --incr --relax -prj tb_mem_top_vlog.prj"
call xvlog  --incr --relax -prj tb_mem_top_vlog.prj -log xvlog.log
