...
HD_PWD='D:/Documents/SEM 2/HWLAB_TA/Memory_stage/Memory_stage.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mem_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_mem_fpga.tcl -notrace
