...
HD_PWD='D:/Documents/SEM 2/HWLAB_TA/Memory_stage/Memory_stage.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mem_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_mem_fpga.tcl
